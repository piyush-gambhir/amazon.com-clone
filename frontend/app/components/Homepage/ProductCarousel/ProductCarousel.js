...
export default function ProductCarousel({ ProductCarouselHeading, ProductCarouelViewAllLink, ProductCarouselLinks }) {
    const ProductCarouselDescription = 'Product Carousel Description';
    ...
    useEffect(() => {
        ...
        const maxScroll = (imageWidth + gap) * ProductCarouselLinks.length - carouselRef.current.offsetWidth;
    ...
    return (
        <div className="bg-white flex flex-col relative overflow-hidden py-[10px] px-[20px] mx-6">
