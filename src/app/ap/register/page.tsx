...
//     description: 'Amazon Registration',
// }
        ...
        <div className="flex flex-col gap-5 pt-6 text-[13px] leading-5">
          <div className="flex flex-col">
            <p>
              ...
              <Hyperlink link="/ap/login" text="Sign-In" />
            </p>
            <p>
              Buying for work?{" "}
              <Hyperlink link="" text="Create a free business account" />
            </p>
          </div>
          <div className="">
            By creating an account or logging in, you agree to Amazon’s{" "}
            <Hyperlink link="" text="Conditions of Use" /> and{" "}
            <Hyperlink link="" text="Privacy Policy" />.
          </div>
        </div>
      </div>
    </div>
